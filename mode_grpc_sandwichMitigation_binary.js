...
(async () => {
    ...
    client.SendBinaryTransaction({ binaryTransaction: serializedTransaction, mode: mode, safeWindow: safeWindow, revertProtection: revertProtection}, meta, (err, response) => {
        if (err) {
